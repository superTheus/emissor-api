...
/**
 * Controller para emissão de NFC-e para Microempreendedor Individual (CRT 4)
 *
 * Código exclusivo para MEIs.
 * MEI não destaca impostos na nota fiscal.
 */
class CRT4CupomController extends BaseCupomFiscalController
{
  /**
  ...
  protected function processarImpostosProduto($produto, $index)
  {
    ...
    // Verificar se é combustível (caso raro para MEI)
