...
/**
 * Controller para emissão de NFC-e para empresas do Regime Normal (CRT 3)
 *
 * Usado por empresas no Lucro Presumido ou Lucro Real.
 * ICMS com CST, PIS e COFINS com alíquotas completas.
 */
class CRT3CupomController extends BaseCupomFiscalController
{
  /**
   * Processa os impostos para Regime Normal
   */
